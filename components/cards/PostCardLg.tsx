...
const PostCardLg = ({ post }) => {
  return (
    <Link href={`posts/${post.slug}`}>
      <div className="cursor-pointer snap-start flex flex-col shadow-lg bg-neutral-200 dark:bg-neutral-900 min-w-[75%] md:min-w-[100%] rounded-xl col-span-1 overflow-hidden will-change-transform ">
        <div className="relative overflow-hidden aspect-square">
          ...
          >
            <Menu.Items className="absolute right-4 top-8 z-50 mt-4 w-56 origin-top-right rounded-lg bg-white/75 backdrop-blur-lg shadow-lg ring-1 ring-black ring-opacity-5 focus:outline-none dark:bg-neutral-800/75">
        ...
        <div className="flex flex-col gap-1 justify-center min-h-16 flex-1 bg-white dark:bg-neutral-900 p-4 text-center">
          <h2 className="text-base md:text-xl leading-tight font-semibold text-black dark:text-white line-clamp-2">
            {post.title}
          </h2>
          <p className="text-neutral-400 text-sm line-clamp-2 pb-1">
            {post.description}
          </p>
        </div>
      </div>

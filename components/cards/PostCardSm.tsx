...
const PostCardSm = ({ post }) => {
  return (
    <div className="shadow-lg bg-white dark:bg-neutral-900 divide-neutral-200 dark:divide-neutral-800 divide-y rounded-xl flex flex-col justify-between col-span-2 md:col-span-1">
      <Link href={`posts/${post.slug}`} target="_blank">
        <div className="cursor-pointer p-4 flex justify-between gap-4">
          <div className='flex flex-col gap-1'>
            <h2 className="text-black dark:text-white font-semibold text-base leading-tight line-clamp-3">
              {post.title}
            </h2>
          ...
          <div className="relative overflow-hidden min-w-[7rem] w-28 h-28 aspect-square rounded-lg">
            <Image
              layout="fill"
